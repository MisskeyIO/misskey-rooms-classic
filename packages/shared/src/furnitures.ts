...
export const furnitureDefs: FurnitureDef[] = [
  ...
  { id: "low-table", name: "ローテーブル", place: "floor", props: { color: "color" }, color: { Table: "color" } },
  { id: "desk", name: "デスク", place: "floor", props: { color: "color" }, color: { Board: "color" } },
  { id: "chair", name: "椅子", place: "floor", props: { color: "color" }, color: { Chair: "color" } },
  {
    id: "chair2",
    name: "椅子2",
    place: "floor",
  ...
  { id: "mousepad", name: "マウスパッド", place: "floor", props: { color: "color" }, color: { Pad: "color" } },
  {
    id: "monitor",
    name: "モニター",
    place: "floor",
  ...
  { id: "color-box", name: "カラーボックス", place: "floor", props: { color: "color" }, color: { main: "color" } },
  { id: "wall-clock", name: "壁時計", place: "wall" },
  { id: "cube", name: "キューブ", place: "floor", props: { color: "color" }, color: { Cube: "color" } },
  {
    id: "photoframe",
    name: "フォトフレーム",
    place: "wall",
  ...
  { id: "sofa", name: "ソファ", place: "floor", props: { color: "color" }, color: { Sofa: "color" } },
  { id: "spiral", name: "螺旋階段", place: "floor", props: { color: "color" }, color: { Step: "color" } },
